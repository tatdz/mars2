...
export function GroupChat() {
  ...
  const handleRevealMessage = async (index: number, ciphertext: string) => {
    // In a real implementation, this would decrypt the message first
    // For now, we'll simulate revealing with a placeholder
    try {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold">Validator Group Messages</h2>
                    ...
                    messages.map((message) => (
                      <div
                        ...
                        className={`bg-dark-bg p-4 rounded-lg ${
                          message.revealed ? "border-l-4 border-validator-green" : ""
                        }`}
                      >
                        <div className="flex justify-between items-start mb-2">
                          <div className="flex items-center space-x-2">
                            <div className={`w-6 h-6 rounded-full ${
                              message.revealed ? "bg-validator-green" : "bg-gray-600"
                            }`}></div>
          ...
          <Card className="bg-dark-card border-gray-700">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span>{messageStats.userMessages}</span>
              </div>
            </CardContent>
          </Card>
