              ...
              <div className="mt-6 p-4 bg-dark-bg rounded border border-gray-600">
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    ...
                    <div className="text-xs text-white">Active Validators</div>
                  </div>
                  <div>
                    <div className="text-white text-lg font-bold">23</div>
                    <div className="text-xs text-white">Messages Today</div>
                  </div>
                  <div>
                    <div className="text-white text-lg font-bold">100%</div>
                    <div className="text-xs text-white">Encrypted</div>
                  </div>
                </div>
              </div>
            </CardContent>
                  ...
                  {demoMessages.map((message) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <div className="w-6 h-6 bg-purple-accent rounded-full flex items-center justify-center text-xs font-bold text-white">
